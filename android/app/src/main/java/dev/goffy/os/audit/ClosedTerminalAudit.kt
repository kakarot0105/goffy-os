...
private fun String?.displayCommand(): String = when (this) {
    ...
    GOFFY_ROM_CHECKLIST_TOOL -> "Recorded GOFFY ROM checklist task"
    GOFFY_ROM_FEATURES_TOOL -> "Recorded GOFFY ROM feature payload task"
    ...
    PHONE_MEMORY_FORGET_TOOL -> "Recorded memory single-delete task"
    ...
    PHONE_MEMORY_UPDATE_TOOL -> "Recorded memory update task"
...
private val AUDIT_CAPABILITY_CONTRACTS = mapOf(
    ...
    GOFFY_ROM_CHECKLIST_TOOL to (ExecutionTarget.MAC to AuditPermission.SAFE),
    GOFFY_ROM_FEATURES_TOOL to (ExecutionTarget.MAC to AuditPermission.SAFE),
    ...
    PHONE_MEMORY_FORGET_TOOL to (ExecutionTarget.PHONE to AuditPermission.CONFIRM),
    ...
    PHONE_MEMORY_UPDATE_TOOL to (ExecutionTarget.PHONE to AuditPermission.CONFIRM),
